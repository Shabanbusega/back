"""
Railway-ready Flask application for AzamPay payment processing
"""
...
CALLBACK_URL = os.environ.get("CALLBACK_URL", "https://ponahealth.com/api/payments/azampay/callback")

@app.route('/')
def index():
    return "Pona Health Payment API Server - Railway Deployment"
    
@app.route('/api/health')
def health_check():
    return jsonify({
        "status": "healthy",
        "message": "Payment API server is running on Railway",
